...
//		String prog = "";	
//		String input = prog + "abc 9999999999919199199100100110101010100111.1";
//		byte[] bytecode = genCode(input);
//		String[] commandLineArgs = {};
//		runCode(prog, bytecode, commandLineArgs);
//		show("Log:\n "+RuntimeLog.globalLog);
...
//	}
	...
	public void t5() throws Exception {
		...
		String input =  prog + "{ image im[256,256]; \nfilename f; \ninput f from @0; "
				...
				+ "y := y + 1; \n};\nx := x + 1;};\nwrite im to f;}";
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"/Users/jessicawin/Desktop/test.png"};		
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n"+RuntimeLog.globalLog);
		//assertEquals("entering main;-13100275;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void testRandom() throws Exception {
		...
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"https://d2droglu4qf8st.cloudfront.net/2016/05/282829/Marbled-Hazelnut-Brownie-Cheesecake-for-a-Crowd_Large400_ID-1680086.jpg","/Users/jessicawin/Desktop/test.png"};		
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n"+RuntimeLog.globalLog);
		//assertEquals("entering main;-13100275;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void declareAndAssign181() throws Exception {
		...
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"/Users/jessicawin/Desktop/test.png"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
//		assertEquals("entering main;36.758343;leaving main;",RuntimeLog.globalLog.toString());
	}
